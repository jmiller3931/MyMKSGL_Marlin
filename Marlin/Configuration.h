...
#define STRING_CONFIG_H_AUTHOR "(My, Ender-3)" // Who made the changes.
...
#define HOMING_FEEDRATE_Z  (10*60)    // default 4*60, can go as high as 20*60
